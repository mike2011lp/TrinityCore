...
class spell_yoggsaron_lunatic_gaze : public SpellScriptLoader
{
    public:
        ...
        class spell_yoggsaron_lunatic_gaze_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnObjectAreaTargetSelect  += SpellObjectAreaTargetSelectFn(spell_yoggsaron_lunatic_gaze_SpellScript::FilterTargets, EFFECT_0, TARGET_UNIT_SRC_AREA_ENEMY);
                OnObjectAreaTargetSelect  += SpellObjectAreaTargetSelectFn(spell_yoggsaron_lunatic_gaze_SpellScript::FilterTargets, EFFECT_1, TARGET_UNIT_SRC_AREA_ENEMY);
            }
        };
...
class spell_yoggsaron_induce_madness : public SpellScriptLoader
{
    public:
        ...
        class spell_yoggsaron_induce_madness_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnObjectAreaTargetSelect  += SpellObjectAreaTargetSelectFn(spell_yoggsaron_induce_madness_SpellScript::FilterTargets, EFFECT_0, TARGET_UNIT_SRC_AREA_ENEMY);
            }
        };
