...
enum Seats
{
    SEAT_MIMIRON_INTRO_1                    = 4,
    SEAT_MIMIRON_INTRO_2                    = 2,
    SEAT_MIMIRON_INTRO_3                    = 5,
    SEAT_MIMIRON_INTRO_4                    = 6,
    SEAT_MIMIRON_VX001                      = 1,
    SEAT_MIMIRON_AERIAL                     = 4,
    SEAT_TURRET                             = 3,
};
    ...
    public:
        ...
        struct boss_mimironAI : public BossAI
        {
            ...
            void Reset()
            {
                ...
                checkBotAlive = true;
                Enraged = false;
                DespawnCreatures(NPC_PROXIMITY_MINE, 100);
            ...
            void EndEncounter()
            {
                ...
                if (instance)
                {
                    ...
                    // TODO: Achivement Proper Implementation
                    /*if (MimironHardMode)
                    {
            ...
            void UpdateAI(const uint32 diff)
            {
                        ...
                        if (Creature* leviathan = me->GetCreature(*me, instance->GetData64(DATA_LEVIATHAN_MK_II)))
                            if (Creature* vx001 = me->GetCreature(*me, instance->GetData64(DATA_VX_001)))
                                if (Creature* aerialUnit = me->GetCreature(*me, instance->GetData64(DATA_AERIAL_UNIT)))
                                    if (leviathan->getStandState() == UNIT_STAND_STATE_DEAD || vx001->getStandState() == UNIT_STAND_STATE_DEAD || aerialUnit->getStandState() == UNIT_STAND_STATE_DEAD)
                                    {
                    ...
                    if (uiPhase_timer <= diff)
                    {
                        switch (uiStep)
                        {
                            ...
                            case 2:
                                if (instance)
                                    if (Creature* leviathan = me->GetCreature(*me, instance->GetData64(DATA_LEVIATHAN_MK_II)))
                                        me->_EnterVehicle(leviathan->GetVehicleKit(), SEAT_MIMIRON_INTRO_1);

                                JumpToNextStep(2000);
                                break;
                            case 3:
                                me->ChangeSeat(SEAT_MIMIRON_INTRO_2);
                                JumpToNextStep(2000);
                                break;
                            case 4:
                                me->ChangeSeat(SEAT_MIMIRON_INTRO_3);
                            ...
                            case 5:
                                ...
                                break;
                            case 6:
                                me->ChangeSeat(SEAT_MIMIRON_INTRO_4);
                                JumpToNextStep(2000);
                                break;
                            case 7:
                                if (instance)
                    ...
                    if (uiPhase_timer <= diff)
                    {
                        switch (uiStep)
                        {
                            case 1:
                                ...
                                break;
                            case 2:
                                me->ChangeSeat(SEAT_MIMIRON_VX001);
                                JumpToNextStep(2000);
                                break;
                            case 3:
                                if (instance)
                            ...
                            case 4:
                                if (instance)
                                {
                                    if (Creature* vx001 = me->SummonCreature(NPC_VX_001, 2744.65f, 2569.46f, 364.397f, 3.14159f, TEMPSUMMON_CORPSE_TIMED_DESPAWN, 10000))
                                    {
                                        instance->SetData(DATA_MIMIRON_ELEVATOR, GO_STATE_ACTIVE_ALTERNATIVE);
                                        vx001->SetVisible(true);
                                        ...
                                        for (uint8 n = 5; n < 7; n++)
                                        {
                                            if (Creature* rocket = me->SummonCreature(NPC_ROCKET, me->GetPositionX(), me->GetPositionY(), me->GetPositionZ(), 0, TEMPSUMMON_MANUAL_DESPAWN))
                                            {
                                                ...
                                                rocket->_EnterVehicle(vx001->GetVehicleKit(), n);
                                            }
                                        }
                                    }
                                }
                            ...
                            case 5:
                                ...
                                {
                                    if (Creature* vx001 = me->GetCreature(*me, instance->GetData64(DATA_VX_001)))
                                        me->_EnterVehicle(vx001->GetVehicleKit(), 0);
                                }
                            ...
                            case 9:
                                if (instance)
                                    if (Creature* vx001 = me->GetCreature(*me, instance->GetData64(DATA_VX_001)))
                                    {
                                        vx001->AddAura(SPELL_HOVER, vx001); // Hover
                                        vx001->AI()->DoAction(DO_START_VX001);
                                        phase = PHASE_COMBAT;
                                    }
                                break;
                            default:
                ...
                if (phase == PHASE_AERIAL_ACTIVATION)
                {
                    if (uiPhase_timer <= diff)
                    {
                        ...
                        {
                            case 1:
                                me->ChangeSeat(SEAT_MIMIRON_AERIAL);
                                me->SetUInt32Value(UNIT_NPC_EMOTESTATE, EMOTE_STATE_STAND);
                                JumpToNextStep(2500);
                                break;
                            case 2:
                            ...
                            case 4:
                                ...
                                if (Creature* aerialUnit = me->GetCreature(*me, instance->GetData64(DATA_AERIAL_UNIT)))
                                     me->_EnterVehicle(aerialUnit->GetVehicleKit(), 0);
                        ...
                        switch (uiStep)
                        {
                            case 1:
                                if (instance)
                                {
                                    ...
                                    if (Creature* vx001 = me->GetCreature(*me, instance->GetData64(DATA_VX_001)))
                                    {
                                        me->_EnterVehicle(vx001->GetVehicleKit(), 1);
                                        me->SetUInt32Value(UNIT_NPC_EMOTESTATE, EMOTE_STATE_STAND);
                            ...
                            case 2:
                                if (instance)
                                    if (Creature* vx001 = me->GetCreature(*me, instance->GetData64(DATA_VX_001)))
                                        if (Creature* leviathan = me->GetCreature(*me, instance->GetData64(DATA_LEVIATHAN_MK_II)))
                                        {
                                            vx001->SetStandState(UNIT_STAND_STATE_STAND);
                                            vx001->SetUInt32Value(UNIT_NPC_EMOTESTATE, EMOTE_STATE_CUSTOM_SPELL_01);
                                            vx001->_EnterVehicle(leviathan->GetVehicleKit(), 7);
                                        }
                                ...
                                if (instance)
                                    if (Creature* vx001 = me->GetCreature(*me, instance->GetData64(DATA_VX_001)))
                                        if (Creature* aerialUnit = me->GetCreature(*me, instance->GetData64(DATA_AERIAL_UNIT)))
                                        {
                                            ...
                                            aerialUnit->_EnterVehicle(vx001->GetVehicleKit(), 3);
                            ...
                            case 4:
                                if (instance)
                                {
                                    ...
                                    if (Creature* vx001 = me->GetCreature(*me, instance->GetData64(DATA_VX_001)))
                                        vx001->AI()->DoAction(DO_VX001_ASSEMBLED);
                        ...
                        switch(eventId)
                        {
                            ...
                            case EVENT_FLAME_SUPPRESSANT:
                                ...
                                for (int8 n = 0; n < 2; n++)
                                {
                                    ...
                                    std::list<Creature*> m_creatures;
                                    GetCreatureListWithEntryInGrid(m_creatures, me, npc, 100);
                ...
                if (uiSprayTimer <= uiDiff)
                {
                    ...
                    for (int8 n = 0; n < 2; n++)
                    {
                        ...
                        if (n == 0)
                            ...
                            npc = NPC_FLAME_SPREAD;
                        std::list<Creature*> m_creatures;
                        GetCreatureListWithEntryInGrid(m_creatures, me, npc, 12);
            ...
            void UpdateAI(const uint32 diff)
            {
                if (uiFrostTimer <= diff)
                {
                    ...
                    for (int8 n = 0; n < 2; n++)
                    {
                        ...
                        std::list<Creature*> m_creatures;
                        GetCreatureListWithEntryInGrid(m_creatures, me, npc, 25);
